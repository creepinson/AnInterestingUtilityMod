...
public class UpdateEntityWhitelistHandler implements IMessageHandler<PacketUpdateEntityWhitelist, IMessage> {
  // Do note that the default constructor is required, but implicitly defined in this case

  @Override public IMessage onMessage(PacketUpdateEntityWhitelist message, MessageContext ctx) {
